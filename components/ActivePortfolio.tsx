            ...
            <div className="relative w-48 h-48">
              ...
              >
                <circle
                  ...
                  stroke="#22c55e"
                  strokeWidth="20"
                  strokeDasharray={`${strategy.stable_ratio * 2.51} ${
                    (100 - strategy.stable_ratio) * 2.51
                  }`}
                />
                <circle
                  cx="50"
                  ...
                  stroke="#3b82f6"
                  strokeWidth="20"
                  strokeDasharray={`${strategy.token_ratio * 2.51} ${
                    (100 - strategy.token_ratio) * 2.51
                  }`}
